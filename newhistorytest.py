...
if(len(moneylist)==1):
    ...
    if(len(moneylist)%2==0): #偶數
        for i in range(1,len(moneylist),2):
...
if(count==1):
    ...
    print('目前無持股')
print('報酬:',Decimal(money*1000).quantize(Decimal("0.01"), rounding = "ROUND_HALF_UP"))   
print('買入日期:')
